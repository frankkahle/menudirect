...
<body class="bg-gray-50 text-gray-900">
        ...
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                @auth
                    ...
                    <!-- Help Link -->
                    @php $isHelp = request()->routeIs('client.help.*'); @endphp
                    <a href="{{ route('client.help.index') }}" class="text-sm flex items-center gap-1 {{ $isHelp ? 'font-medium text-indigo-600 border-b-2 border-indigo-600 pb-1' : 'text-gray-600 hover:text-indigo-600' }}" title="Help articles and guides">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Help drawer (slides in from the right; available on every client page) --}}
    @auth
        @include('components.help-drawer')
    @endauth
